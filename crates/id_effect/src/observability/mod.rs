...
//! | [`tracing`] | [`TracingConfig`], span/fiber/compute hooks | Stratum 7 (`concurrency::fiber_ref`), Stratum 14 (`collections::hash_map`), Stratum 2 (`kernel`) |
...
pub use tracing::{
  ...
  LogSpan, SpanRecord, TracingConfig, TracingFiberRefs, TracingSnapshot, annotate_current_span,
  emit_compute_event, emit_effect_event, emit_fiber_event, install_tracing_layer,
  record_compute_event, snapshot_tracing, with_span,
};
